...
const Planos = () => {
  const plans = [
    {
      name: "Plano Mensal",
      description: "Flexibilidade máxima para começar",
      features: [
        "Suporte remoto ilimitado",
        "Suporte presencial quando necessário",
        "SLA de 4 horas para resposta",
    ...
    },
    {
      ...
      features: [
        ...
        "SLA prioritário de 2 horas",
        "Manutenção preventiva mensal",
        "Consultoria de TI inclusa",
        "Suporte emergencial 24h",
        "Relatórios detalhados",
        "Desconto de até 20%",
        "Revisão trimestral de infraestrutura",
      ],
      highlighted: true,
    ...
    },
    {
      ...
      description: "Equilíbrio entre flexibilidade e economia",
      features: [
        "Tudo do plano mensal",
        "SLA de 3 horas para resposta",
